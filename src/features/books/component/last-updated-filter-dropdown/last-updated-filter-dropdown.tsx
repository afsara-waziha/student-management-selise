// Path: src/features/books/component/last-updated-filter-dropdown/last-updated-filter-dropdown.tsx
...
/**
 * Books — LastUpdatedFilterDropdown
 *
 * Same behavior as Students/Inventory:
 *  - today
 *  - date
 *  - date range
 *  - after / before
