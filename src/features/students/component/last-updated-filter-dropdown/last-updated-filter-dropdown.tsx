// Path: src/features/students/component/last-updated-filter-dropdown/last-updated-filter-dropdown.tsx
...
/**
 * Students — LastUpdatedFilterDropdown
 *
 * Identical behavior to inventory's dropdown: lets users pick:
 *  - today
 *  - specific date
 *  - date range
 *  - after/before a date
 *  - no_entry
 *
 * Sends a filter object via `setFilterValue`, e.g.:
 *   { type: 'date', date: Date }
 *   { type: 'date_range', from: Date, to: Date }
 *   { type: 'after' | 'before' | 'today' | 'no_entry', date?: Date }
 *
 * Exposes `clearFilter()` via ref.
 */
